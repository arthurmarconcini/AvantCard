  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-card border border-border/40 rounded-3xl p-6 flex flex-col justify-between relative overflow-hidden group">
        ...
        <div className="flex items-center gap-2 mt-6">
          <Badge variant="outline" className="bg-cyan-500/10 text-cyan-400 border-cyan-500/20 gap-1 px-2.5 py-0.5">
            <Banknote className="w-3 h-3" />
            {cashAccountsCount} {cashAccountsCount === 1 ? "conta" : "contas"}
          </Badge>
          <span className="text-xs text-muted-foreground">vinculadas</span>
        </div>
        <Banknote className="absolute right-6 top-6 w-12 h-12 text-cyan-500/10 group-hover:text-cyan-500/20 transition-colors" />
      </div>
