...
export default function DashboardPage() {
  return (
    <div className="flex h-screen w-full bg-background text-foreground overflow-hidden font-sans">
      {/* SIDEBAR */}
      <aside className="w-64 border-r border-border/40 bg-background hidden md:flex flex-col justify-between shrink-0">
        <div>
          {/* Logo Section */}
          <div className="h-20 flex items-center px-6 border-b border-border/40">
            <div className="flex items-center gap-3">
              <div className="relative flex items-center justify-center w-8 h-8 rounded-full bg-primary/10">
                {/* Lança interceptando um cartão logo mock */}
                <div className="absolute w-5 h-0.5 bg-primary rotate-45" />
                <div className="absolute w-4 h-3 border border-primary rounded-[2px] -rotate-12 bg-background/50" />
              </div>
              <div className="flex flex-col">
                <span className="font-bold text-lg leading-tight">ThinkCard</span>
          ...
          <div className="px-4 py-6 space-y-8">
            <div>
              <p className="px-2 text-xs font-semibold text-muted-foreground mb-3 tracking-wider">MENU</p>
              <nav className="space-y-1">
                ...
                <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-secondary/50 font-medium transition-colors">
            ...
            <div>
              <p className="px-2 text-xs font-semibold text-muted-foreground mb-3 tracking-wider">SETTINGS</p>
              <nav className="space-y-1">
                <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-secondary/50 font-medium transition-colors">
        ...
        <div className="p-4 border-t border-border/40">
          <Button className="w-full gap-2 font-bold text-base h-12 rounded-xl" size="lg">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* TOP BAR */}
        <header className="h-20 border-b border-border/40 bg-background/95 backdrop-blur flex items-center justify-between px-8 z-10 shrink-0">
          <div className="relative w-full max-w-md">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
            <Input
              placeholder="Buscar transações, amigos, contas..."
              className="w-full pl-10 bg-secondary/30 border-none h-11 rounded-xl text-sm placeholder:text-muted-foreground focus-visible:ring-1 focus-visible:ring-primary/50"
            />
          </div>
          ...
          <div className="flex items-center gap-6">
            <button className="relative text-muted-foreground hover:text-foreground transition-colors">
              ...
              <span className="absolute 0 top-0.5 right-0.5 w-2 h-2 rounded-full bg-primary ring-2 ring-background"></span>
            </button>
            <div className="h-8 w-px bg-border/50" />
            <div className="flex items-center gap-3 cursor-pointer">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-semibold leading-tight">Alex Avantech</p>
